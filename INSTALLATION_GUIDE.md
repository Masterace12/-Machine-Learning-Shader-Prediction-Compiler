...
curl -fsSL https://raw.githubusercontent.com/Masterace12/-Machine-Learning-Shader-Prediction-Compiler/main/install.sh | bash -s -- --no-autostart

# Force reinstall over existing installation
curl -fsSL https://raw.githubusercontent.com/Masterace12/-Machine-Learning-Shader-Prediction-Compiler/main/install.sh | bash -s -- --force

# Skip system dependency installation
curl -fsSL https://raw.githubusercontent.com/Masterace12/-Machine-Learning-Shader-Prediction-Compiler/main/install.sh | bash -s -- --skip-deps
```
...
LATEST_VERSION=$(curl -s https://api.github.com/repos/Masterace12/-Machine-Learning-Shader-Prediction-Compiler/releases/latest | grep '"tag_name"' | cut -d'"' -f4)
curl -L "https://github.com/Masterace12/-Machine-Learning-Shader-Prediction-Compiler/archive/refs/tags/${LATEST_VERSION}.tar.gz" -o shader-compiler.tar.gz

# Download checksums
curl -L "https://github.com/Masterace12/-Machine-Learning-Shader-Prediction-Compiler/releases/download/${LATEST_VERSION}/SHA256SUMS" -o SHA256SUMS
...
RUN curl -fsSL https://raw.githubusercontent.com/Masterace12/-Machine-Learning-Shader-Prediction-Compiler/main/install.sh | bash
...
```bash
curl -fsSL https://raw.githubusercontent.com/Masterace12/-Machine-Learning-Shader-Prediction-Compiler/main/uninstall.sh | bash
```
...
curl -fsSL https://raw.githubusercontent.com/Masterace12/-Machine-Learning-Shader-Prediction-Compiler/main/uninstall.sh | bash -s -- --backup

# Keep configuration files
curl -fsSL https://raw.githubusercontent.com/Masterace12/-Machine-Learning-Shader-Prediction-Compiler/main/uninstall.sh | bash -s -- --keep-config

# Preview what would be removed
curl -fsSL https://raw.githubusercontent.com/Masterace12/-Machine-Learning-Shader-Prediction-Compiler/main/uninstall.sh | bash -s -- --dry-run
```
...
1. 📖 Check the [Troubleshooting Wiki](https://github.com/Masterace12/-Machine-Learning-Shader-Prediction-Compiler/wiki/Troubleshooting)
2. 🐛 Search [GitHub Issues](https://github.com/Masterace12/-Machine-Learning-Shader-Prediction-Compiler/issues)
3. 💬 Ask in [GitHub Discussions](https://github.com/Masterace12/-Machine-Learning-Shader-Prediction-Compiler/discussions)
4. 🆕 Create a [New Issue](https://github.com/Masterace12/-Machine-Learning-Shader-Prediction-Compiler/issues/new) with:
...
**Installation successful?** 🎉 Check out the [User Guide](https://github.com/Masterace12/-Machine-Learning-Shader-Prediction-Compiler/wiki/User-Guide) to get started!